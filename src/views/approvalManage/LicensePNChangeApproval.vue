	...
	<div class="tw-template-wrapper">
		...
		<div class="tw-query-panel">
			<el-table :data="filterTableList" v-loading="table.loading" border size="small" height="calc(100% - 42px)" style="width: 100%; margin-bottom: 10px;">
				...
				<el-table-column prop="ycphm" label="原车牌号码" width="140" align="center"></el-table-column>
				<el-table-column prop="xcphm" label="现车牌号码" width="140" align="center"></el-table-column>
	...
	export default {
		...
		methods: {
			...
			getLicenseChange(){
				...
				const {odlVehicle, newVehicle, area, stime, etime, type} = this.query;
				axios.get('area/licensechange', {
