...
<template>
	<div class="tw-template-wrapper">
		<el-form :inline="true" :model="query" size="small" class="tw-query-bar">
			...
			<el-form-item>
				<el-input v-model="query.count" placeholder="回场次数"></el-input>
			</el-form-item>
			<el-form-item>
		...
		<div class="tw-query-panel">
			<el-table :data="filterTableList" v-loading="table.loading" border size="small" height="calc(100% - 42px)" style="width: 100%; margin-bottom: 10px;">
				...
				<el-table-column prop="hcss" label="回场时间" width="150"></el-table-column>
				<el-table-column label="回场间隔" width="150">
					<template slot-scope="scope">
						<tw-unit :data="scope.row.hcjg" unit="天"></tw-unit>
					</template>
				</el-table-column>
				<el-table-column prop="hccs" label="回场次数" min-width="160" :resizable="false"></el-table-column>
			</el-table>
