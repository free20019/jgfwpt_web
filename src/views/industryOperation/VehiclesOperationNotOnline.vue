    ...
    <div class="tw-template-wrapper">
        ...
        <div class="tw-query-panel">
            <el-table :data="table.data" v-loading="table.loading" border size="small" height="calc(100% - 42px)" style="width: 100%; margin-bottom: 10px;">
                ...
                <el-table-column prop="ADDRESS" label="最后定位上传地点" width="300"></el-table-column>
                <el-table-column prop="LATEST_TIME" label="最后定位上传时间" width="250"></el-table-column>
                <el-table-column prop="CATCH_TIME" label="抓拍时间" width="250"></el-table-column>
            </el-table>
        ...
        methods: {
            ...
            handleExportClick() {
                ...
                this.$confirm('是否需要导出?', '提示', {
                    ...
                    window.open(`${this.baseURL}industryOperation/getVehiclesOperationNotOnlineExcel?vehicle=${vehicle}&area=${area}&sTime=${sTime && moment(sTime).format('YYYY-MM-DD 00:00:00')}&eTime=${eTime && moment(eTime).format('YYYY-MM-DD 23:59:59')}&type=${type}`);
                }).catch(() => {});
            },
        },
        components: {
