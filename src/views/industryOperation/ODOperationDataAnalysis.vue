	...
	<div class="tw-template-wrapper">
		...
		<div class="tw-query-panel">
			<el-table :data="showcase" border size="small" height="81px" style="width: 100%; margin-bottom: 10px;">
				<el-table-column prop="TJCS" label="总营运次数/次" align="center"></el-table-column>
				<el-table-column prop="CPHM" label="营运车辆数/辆" align="center"></el-table-column>
				<el-table-column prop="YSSC" label="平均营运时长/分钟" align="center"></el-table-column>
				<el-table-column prop="DHSJ" label="平均等候时间/分钟" align="center"></el-table-column>
				<el-table-column prop="JINE" label="平均营收情况/元" align="center"></el-table-column>
				<el-table-column prop="SZLC" label="平均实载里程/公里" align="center"></el-table-column>
			</el-table>
			<el-table :data="table.data" v-loading="table.loading" border size="small" height="calc(100% - 132px)" style="width: 100%; margin-bottom: 10px;">
				...
				<el-table-column prop="JICHENG" label="计程/公里" width="140"></el-table-column>
				<el-table-column prop="DENGHOU" label="等候时间/分钟" width="140"></el-table-column>
				<el-table-column prop="JINE" label="交易金额/元" width="140"></el-table-column>
				<el-table-column prop="KONGSHI" label="空驶/公里" width="140"></el-table-column>
		...
		methods: {
			...
			handleExportClick() {
				...
				this.$confirm('是否需要导出?', '提示', {
					...
					window.open(`${this.baseURL}industryOperation/getODOperationDataAnalysisExcel?SJD=${timePeriod}&QD=${startPoint}&stime=${stime && moment(stime).format('YYYY-MM-DD HH:mm:ss')}&etime=${etime && moment(etime).format('YYYY-MM-DD HH:mm:ss')}`);
				}).catch(() => {
				});
			},
