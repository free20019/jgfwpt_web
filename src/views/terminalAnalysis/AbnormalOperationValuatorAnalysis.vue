        ...
        methods: {
            ...
            handleExportClick() {
                ...
                this.$confirm('是否需要导出?', '提示', {
                    ...
                    window.open(`${this.baseURL}keyArea/getAbnormalOperationValuatorAnalysisExcel?vehicle=${vehicle}&area=${area}&stime=${stime && moment(stime).format('YYYY-MM-DD HH:mm:ss')}&etime=${etime && moment(etime).format('YYYY-MM-DD HH:mm:ss')}`);
                }).catch(() => {});
            },
