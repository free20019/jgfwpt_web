    ...
    <div class="tw-template-wrapper">
        ...
        <div class="tw-query-panel">
            <el-table :data="filterTableList" v-loading="table.loading" border size="small" height="calc(100% - 42px)" style="width: 100%">
                ...
                <el-table-column prop="qdsj" label="最近签到时间" width="160"></el-table-column>
                <el-table-column prop="qtsj" label="最近签退时间" width="160"></el-table-column>
            </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            getUnSignInAndSignOff(){
                ...
                this.table.loading = true;
                axios.get('terminal/unSignInAndSignOff', {
                    baseURL: this.baseURL,
                    params: {
                        vehicle,
                        companyName,
            ...
            handleExportClick() {
                ...
                this.$confirm('是否需要导出?', '提示', {
                    ...
                    window.open(`${this.baseURL}terminal/unSignInAndSignOffdc?vehicle=${vehicle}&companyName=${companyName}&area=${area}&stime=${stime && moment(stime).format('YYYY-MM-DD')}&etime=${etime && moment(etime).format('YYYY-MM-DD')}`);
                }).catch(() => {});
            },
            ...
            handleInputClick(){
                ...
                this.dialog.form.message = companyName===''?'':companyName+'你好,你公司车辆('+vehicle.toString()+')已经7天未签到签退，请及时处理'
            },
