...
<template>
    <div class="tw-template-wrapper">
        <el-form :inline="true" :model="query" size="small" class="tw-query-bar">
            ...
            <el-form-item>
                <el-date-picker v-model="query.stime" type="datetime" placeholder="下线开始日期"></el-date-picker>
            </el-form-item>
            <el-form-item>
                <el-date-picker v-model="query.etime" type="datetime" placeholder="下线结束日期"></el-date-picker>
            </el-form-item>
            <el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            getOccasionalDropOffVehicleInquiry(){
                ...
                const {vehicle, area, count,stime,etime} = this.query;
            ...
            handleExportClick() {
                ...
                this.$confirm('是否需要导出?', '提示', {
                    ...
                    window.open(`${this.baseURL}terminal/occasionaldropoffvehicleinquirydc?vehicle=${vehicle}&area=${area}&count=${count}&stime=${stime && moment(stime).format('YYYY-MM-DD HH:mm:ss')}&etime=${etime && moment(etime).format('YYYY-MM-DD HH:mm:ss')}`);
                }).catch(() => {});
            },
