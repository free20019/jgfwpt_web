    ...
    export default {
        ...
        mounted() {
            this.$nextTick(() => {
                ...
                this.getKeyAreasVehicleQuantityYearReport();
                window.onresize = () => {
        ...
        methods: {
            ...
            /*数据接口*/
            getKeyAreasVehicleQuantityYearReport(){
            ...
            handleExportClick() {
                ...
                this.$confirm('是否需要导出?', '提示', {
                    ...
                    window.open(`${this.baseURL}keyArea/getKeyAreasVehicleQuantityHalfAYearReportExcel?area=${area}&time=${time&&formatYear(time)}&type=0`);
                }).catch(() => {});
            },
