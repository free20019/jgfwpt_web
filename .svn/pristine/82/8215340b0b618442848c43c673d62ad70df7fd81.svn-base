	...
	<div class="tw-template-wrapper">
		...
		<div class="tw-query-panel">
			<el-table :data="filterTableList" v-loading="table.loading" border size="small" height="calc(100% - 42px)" style="width: 100%; margin-bottom: 10px;">
				...
				<el-table-column prop="VEHICLE_TYPE_NAME" label="车辆类型" width="120"></el-table-column>
				...
				<el-table-column prop="FUEL_NAME" label="燃料类型" width="120"></el-table-column>
	...
	export default {
		...
		methods: {
			...
			getTerminalInstalled(){
				...
				const {vehicle, region, stime, etime} = this.query;
