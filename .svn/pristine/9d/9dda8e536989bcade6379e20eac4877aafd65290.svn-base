    ...
    <div class="tw-template-wrapper">
        ...
        <div class="tw-query-panel">
            <el-table :data="filterTableList" v-loading="table.loading" border size="small" height="calc(100% - 42px)" style="width: 100%; margin-bottom: 10px;">
                ...
                <el-table-column prop="gzlx" label="违章类型" width="140"></el-table-column>
                <el-table-column prop="gzsj" label="违章时间" width="160"></el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getDataExceptionOrder(){
                this.table.loading = true;
                const {vehicle,area, stime,etime}= this.query;
                axios.get('keyArea/getDataExceptionOrder', {
            ...
            getWorkOrderAudit(){
                ...
                axios.get('keyArea/getWorkOrderAudit', {
                    baseURL: this.baseURL,
                    params: {
                        id:item.id,
                        remarks:this.dialog.form.remarks,
                        check_id:item.check_id
                    }
                }).then(res => {
                    if(res.data>0){
            ...
            handleExportClick() {
                ...
                this.$confirm('是否需要导出?', '提示', {
                    ...
                    window.open(`${this.baseURL}keyArea/getDataExceptionOrderExcel?vehicle=${vehicle}&area=${area}&stime=${stime && moment(stime).format('YYYY-MM-DD HH:mm:ss')}&etime=${etime && moment(etime).format('YYYY-MM-DD HH:mm:ss')}`);
                }).catch(() => {
                });
            },
