        ...
        methods: {
            ...
            handleExportClick(item) {
                ...
                this.$confirm('是否需要导出?', '提示', {
                    ...
                    window.open(`${this.baseURL}keyArea/getAbnormalOperatingMileageAnalysisDetailsExcel?time=${item.TIME}&low=${arr[0]}&high=${arr.length>1?arr[1]:''}&area=${this.query.selectArea}`);
                }).catch(() => {
                });
            },
